...
const INITIAL_AGENTS: Agent[] = [
  { id: "a_concierge", name: "Pi Concierge", type: "chat", status: "live", convs: "12.4K", campaignNames: ["Amber Member Onboarding", "Lapsed VIP Re-engagement", "Points Expiry Reminder", "Elite Tier Win-Back", "Festive Cashback Push"] },
  { id: "a_voice_react", name: "Reactivation Voice", type: "voice", status: "live", convs: "3.1K", campaignNames: ["Lapsed VIP Re-engagement", "Elite Tier Win-Back"] },
  { id: "a_pricing", name: "Pricing Q&A", type: "chat", status: "live", convs: "1.8K", campaignNames: ["Festive Cashback Push"] },
  { id: "a_winback", name: "Win-back Voice", type: "voice", status: "live", convs: "412", campaignNames: ["Elite Tier Win-Back"] },
  { id: "a_support", name: "L1 Support", type: "chat", status: "live", convs: "21.7K", campaignNames: ["Amber Member Onboarding", "Points Expiry Reminder", "Festive Cashback Push", "Lapsed VIP Re-engagement"] },
];
